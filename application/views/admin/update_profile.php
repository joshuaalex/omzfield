							...
							<div class="alert alert-success"><?php echo $_SESSION['success_profile']; ?></div>
							<?php
 							} ?>
											<?php echo validation_errors('<div class="alert alert-danger col-sm-9 col-lg-offset-3">','</div>'); ?>
											<h3>Profile</h3>

								<?php echo form_open_multipart('admin/update_profile/'.$profile_data['id']); ?>
								<span class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" autofocus="autofocus"  class="col-xs-10" name="name" required="required" value="<?php echo $profile_data['name']; ?>" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" autofocus="autofocus" value="<?php echo $profile_data['post']; ?>" class="col-xs-10" name="post" required="required" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<textarea cols="80" rows="10" id="editor1" required="required" placeholder="" name="profile"><?php echo $profile_data['profile']; ?></textarea>
