<section class="page-404" style="background-image: url(<?php echo base_url();?>/assets/images/background/404-page.jpg);">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-center text-dark">
                ...
                <a href="index-2.html" class="btn btn-primary"> <i class="ti-angle-double-left"></i> Back To Home</a>
            </div>
        </div>
    </div>
</section>